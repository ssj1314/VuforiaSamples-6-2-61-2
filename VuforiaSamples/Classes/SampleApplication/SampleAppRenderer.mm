...
{
    delete self.currentRenderingPrimitives;//当前绘制图元
    self.currentRenderingPrimitives = new Vuforia::RenderingPrimitives(Vuforia::Device::getInstance().getRenderingPrimitives());//得到的实例() . 得到绘制图元()
}
