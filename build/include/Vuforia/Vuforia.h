...
enum STORAGE_TYPE {
    STORAGE_APP,            ///< Storage private to the application 存储专用到应用程序
    STORAGE_APPRESOURCE,    ///< Storage for assets bundled with the
                            ///< application 存储与应用捆绑的资产
    STORAGE_ABSOLUTE        ///< Helper type for specifying an absolute path用于指定绝对路径的辅助类型
};
